Attribute VB_Name = "M_220_TPV_Mail_RDT_Done"
Option Explicit

'==================================================================================================
' M_220_TPV_Mail_RDT_Done
'
...
'   M_220 = liquidacion TPV (ingreso por TPV/Bizum)
'   M_120 = liquidacion CTA (ingreso por transferencia bancaria)
'   El asunto de M_220 incluye " - Efectuada!" para mayor claridad al destinatario.
'
' REQUIERE:
...
'   "TPVMailRDTDone" para copiarlo manualmente. Resuelto en 2026 con App Password (CDO).
'==================================================================================================


'--------------------------------------------------------------------------------------------------
' Rut_Email_TPV_RDT_Done
'   Construye y envia el e-mail de confirmacion de RDT realizada para una liquidacion TPV
'--------------------------------------------------------------------------------------------------
Public Sub Rut_Email_TPV_RDT_Done()
    ...
    'With Sheets("TPVMailRDTDone")  ...  'End With
    ...
    aTabla = Array( _
        ...
        Array("", "Importe redistribuido:", _
              "red", Format(Range("Liq_DI_Imp"), "#,##0.00") & " &euro;") _
    )
...
End Sub     '- Rut_Email_TPV_RDT_Done ---
