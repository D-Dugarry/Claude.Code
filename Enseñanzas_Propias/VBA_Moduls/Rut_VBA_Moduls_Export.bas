...
'
' CARPETA PROPUESTA:
'   [Ruta del libro]\[NombreLibro]_VBA_Moduls\
...
'   Propone como destino: [RutaLibro]\[NombreLibro]_VBA_Moduls\
...
Public Sub Rut_VBA_Export_Moduls()
    ...
    ' --- Carpeta propuesta: misma ruta que el libro, sufijo "_VBA_Moduls" ---
    NomLibro = Left(ThisWorkbook.Name, InStrRev(ThisWorkbook.Name, ".") - 1)
    RutaProp = ThisWorkbook.Path & "\" & NomLibro & "_VBA_Moduls"
