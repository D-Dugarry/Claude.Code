...
' ==================================================================================================================================
Sub Rut_Filtro_NumJI_1_en_Tasas()  ' Copiando los Nº de JI en la Tabla, Filtra la Tabla de Tasas con esos JI's --------------------------------
' ==================================================================================================================================
Dim i       As Integer
Dim Lo_Busca_JI        As ListObject
Set Lo_Busca_JI = Hp_BuscarJI_1.ListObjects("Tb_Busca_JI_1")

With Lo_Busca_JI.DataBodyRange
    .Columns(2).ClearContents
    For i = 1 To .Rows.Count
        If .Cells(i, 1) <> "" Then .Cells(i, 2) = Left(.Cells(i, 1), 4) & Right("0000000000000" & Mid(.Cells(i, 1), 6), 13) & Chr(160)
    Next
End With

    Dim JI_Array As Variant
    JI_Array = Application.Transpose(Lo_Busca_JI.DataBodyRange.Columns(2))
    Hp_T_Aplic.Select
    Hp_T_Aplic.Unprotect
    
    If Not Lo_Aplic.AutoFilter Is Nothing Then Lo_Aplic.AutoFilter.ShowAllData
    
    With Lo_Aplic.Range
'        .AutoFilter Field:=CTa_Ref, Criteria1:=Array(JI_Array), Operator:=xlFilterValues
...
' ==================================================================================================================================
Sub Rut_Filtro_NumJI_2_en_Tasas()  ' Copiando los Nº de JI en la Tabla, Filtra la Tabla de Tasas con esos JI's --------------------------------
' ==================================================================================================================================
Dim i       As Integer
Dim Lo_Busca_JI        As ListObject
Set Lo_Busca_JI = Hp_BuscarJI_2.ListObjects("Tb_Busca_JI_2")

With Lo_Busca_JI.DataBodyRange
    .Columns(2).ClearContents
    For i = 1 To .Rows.Count
        If .Cells(i, 1) <> "" Then .Cells(i, 2) = Left(.Cells(i, 1), 17) & Chr(160)
    Next
End With
