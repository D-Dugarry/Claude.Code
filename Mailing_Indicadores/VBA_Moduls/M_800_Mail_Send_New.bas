...
'                       "ext. ____"                  -> extensión telefónica
'                       "https://sc.ua.es/es/_____"  -> URL web en español
'                       "https://sc.ua.es/va/_____"  -> URL web en valenciano
'                       "Servei _____"               -> nombre del servicio
'                       "Unitat _____"               -> nombre de la unidad
'   APP_User_Ext   -> Extensión telefónica (sustituye "ext. ____" en la firma)
'   APP_Web_es     -> URL web en español  (sustituye "https://sc.ua.es/es/_____")
'   APP_Web_va     -> URL web en valenciano (sustituye "https://sc.ua.es/va/_____")
'   APP_Servicio   -> Nombre del servicio (sustituye "Servei _____")
'   APP_Unidad     -> Nombre de la unidad (sustituye "Unitat _____")
...
Public Sub Rut_Email_Send(ByVal Destinatario As String, _
    ...
    ' --- Construir firma sustituyendo los placeholders de APP_MailFirm ---
...
Public Sub Rut_Cambiar_Contrasena_Email()
    ...
    NuevaClau = InputBox("La Contraseña Actual es:   " & Prog__APP.Range("APP_MailClau") & vbCrLf & vbCrLf & _
                         "Introduce la nueva Contraseña: ", "Actualizar Contraseña E-mail")
