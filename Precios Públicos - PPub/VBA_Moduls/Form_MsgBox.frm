...
Debug.Print "---------------- <<< Sub UserForm_Initialize() - Form_MsgBox"
End Sub
...
' ==================== Put this code on the module where you need use. =============================================================
    '''        MsgBx_Msg = "Hello Baby!!" & vbLf & "Esto es un ejemplo de ínea y texto más largo que una línea del cuadro de mensaje."
    '''        MsgBx_Title = "Procedimiento: "
...
Sub SetParameter(Optional TamanoFont As Integer = 16, _
